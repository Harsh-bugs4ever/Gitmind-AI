...
Table: github.pulls          - columns: owner, repo, number, title, body, state, user__login, created_at, merged_at, merged, base__label
Table: github.commits       - columns: owner, repo, ref, sha, commit__message, commit__author__name, commit__author__date, author__login, stats__additions, stats__deletions
...
Important: Do NOT use ORDER BY on github.commits — the API returns newest-first by default and ORDER BY causes timeouts.
"""
